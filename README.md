...
```
curl -o ~/backup-restore.sh https://raw.githubusercontent.com/dedopsys/remnawave-backup-restore/refs/heads/main/backup-restore.sh && chmod +x ~/backup-restore.sh && sudo ~/backup-restore.sh
```
## Команды:
